  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 pt-20 pb-12 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <button
          onClick={() => onBack ? onBack() : onNavigate('professors')}
          className="flex items-center text-gray-400 hover:text-[#B8913D] transition-colors mb-6"
        >
          <ArrowLeft className="w-5 h-5 mr-2" />
          Retour
        </button>

        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 mb-8 border border-gray-700/50">
          <div className="flex flex-col md:flex-row md:items-start md:space-x-8">
            <div className="relative w-32 h-32 rounded-full flex items-center justify-center shadow-xl mb-6 md:mb-0 mx-auto md:mx-0 flex-shrink-0 overflow-hidden">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start text-gray-400 mb-4">
                <Award className="w-5 h-5 mr-2 text-[#B8913D]" />
              ...
              {professor.subscription_price > 0 && (
                <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 border border-[#B8913D]/30 rounded-xl p-6 backdrop-blur-sm">
                  {subscribed ? (
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div className="mb-4 md:mb-0">
                        <div className="text-lg text-white mb-2 flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="px-8 py-3 bg-gradient-to-r from-[#B8913D] to-[#A07F35] text-white font-medium rounded-full hover:shadow-lg hover:shadow-[#B8913D]/50 transition-all whitespace-nowrap"
                      >
                        Gérer l'abonnement
                      </button>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <button
                        ...
                        className="px-8 py-3 bg-gradient-to-r from-[#B8913D] to-[#A07F35] text-white font-medium rounded-full hover:shadow-lg hover:shadow-[#B8913D]/50 transition-all"
                      >
          ...
          <div className="mb-12">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Contenus publics et gratuits</p>
              </div>
            </div>

            {publicPrograms.length > 0 && (
              <div className="mb-8">
                <h3 className="text-lg font-medium text-white mb-4">Programmes</h3>
            ...
            {publicVideos.length > 0 && (
              <div>
                <h3 className="text-lg font-medium text-white mb-4">Vidéos</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {(subscriberPrograms.length > 0 || subscriberVideos.length > 0) && (
          <div className="mb-12">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-[#B8913D] to-[#A07F35] rounded-xl flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Accessible avec l'abonnement au professeur</p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Contenu payant - Accès permanent</p>
              </div>
            </div>
...
function VideoCard({ video, hasAccess, subscribed, onClick, showPrice, onTogglePrice }: VideoCardProps) {
  const getCategoryBadge = () => {
    ...
    if (hasAccess && subscribed) {
      return (
        <div className="absolute top-3 left-3 px-3 py-1 bg-[#B8913D] text-white text-xs font-medium rounded-full flex items-center space-x-1">
  ...
  return (
    <div
      className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-sm hover:shadow-xl hover:shadow-[#B8913D]/20 transition-all overflow-hidden group border border-gray-700/50 hover:border-[#B8913D]/50 cursor-pointer"
      onClick={onClick}
    >
      <div className="relative aspect-video bg-gradient-to-br from-[#B8913D] to-[#A07F35]">
        <div className="absolute inset-0 flex items-center justify-center">
          {hasAccess ? (
            ...
            <Lock className="w-16 h-16 text-white opacity-75" />
          )}
        </div>
        {getCategoryBadge()}
      </div>
  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-gradient-to-br from-[#B8913D] to-[#A07F35]">
        <div className="absolute inset-0 flex items-center justify-center">
          {hasAccess ? (
            <BookOpen className="w-16 h-16 text-white opacity-75 group-hover:opacity-100 transition-opacity" />
          ) : (
            <Lock className="w-16 h-16 text-white opacity-75" />
          )}
        </div>
      ...
      <div className="p-5">
        <div className="flex items-center space-x-2 mb-2">
          <span className="px-2 py-1 bg-[#B8913D]/20 text-[#D4AC5B] text-xs font-medium rounded border border-[#B8913D]/30">
            Programme
          </span>
